          ...
          <>
            ...
            <div style={{marginTop: '32px'}}>
              ...
              {medicines.length === 0 ? (
                ...
                medicines.map(med => (
                  <div key={med.id} style={{backgroundColor: 'white', padding: '16px', borderRadius: '12px', marginBottom: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', border: `3px solid ${med.color}`}}>
                    <div>
                    ...
                    <button onClick={() => toggleTaken(med.id)} style={{backgroundColor: med.taken ? '#16A34A' : '#CBD5E1', color: med.taken ? 'white' : '#475569', padding: '8px 16px', borderRadius: '6px', border: 'none', cursor: 'pointer', fontWeight: '500'}}>
        ...
        {activeTab === 'medicines' && (
          <>
            ...
            {medicines.length === 0 ? (
              ...
              medicines.map(med => (
                <div key={med.id} style={{backgroundColor: 'white', padding: '20px', borderRadius: '12px', marginBottom: '12px', border: `3px solid ${med.color}`}}>
